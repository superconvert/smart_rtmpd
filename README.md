...
<font color=red>一键运行版本已经推出，单机版本：288。支持的操作系统有 windows10, centos8.5, ubuntu22.04, arm64 等系统。预览版本敬请访问</font>  
...
|E-mail(邮箱) |cwf12345@sina.com |
  ...
  2号交流群（可以加）: ![image](images/2号群.jpg)  
  3号交流群（近乎满）: ![image](images/3号群.jpg)  
  嘻嘻1号流群（可加）: ![image](images/嘻嘻1号群.jpg)  
